...
public class UnboundleClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ClientLifecycleEvents.CLIENT_STARTED.register(client ->
			BundleTooltipContext.highContrast = client.getResourcePackRepository().getSelectedIds().contains("high_contrast")
		);
		// ... and on resource pack reload. This flag controls the look of the shadows of 16-stackables and unstackables.
		InvalidateRenderStateCallback.EVENT.register(() ->
			BundleTooltipContext.highContrast = Minecraft.getInstance().getResourcePackRepository().getSelectedIds().contains("high_contrast")
		);
	}
}